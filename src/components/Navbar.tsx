...
import { Calendar, Menu, X, ChevronRight, Rocket, Phone, Mail, Linkedin, Sparkles, ExternalLink } from 'lucide-react';
...
export default function Navbar({ onOpenBooking, onScrollTo }: NavbarProps) {
  ...
  const navLinks = [
    { label: 'InsurUp Teknolojisi', id: 'insurup-teknolojisi', isSpecial: true },
  ...
  return (
    <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-slate-200 transition-all">
      {/* Top micro-announcement / InsurUp Synergy bar */}
      <div className="bg-slate-950 text-slate-200 text-xs py-1.5 sm:py-2 px-3 sm:px-4 border-b border-slate-800">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-2">
          <div className="flex items-center gap-2 truncate">
            ...
            <span className="font-semibold text-emerald-400 shrink-0">InsurUp Ekosistemi:</span>
            <span className="text-slate-300 truncate text-[11px] sm:text-xs">
              Tuğçe Utku • InsurUp Dijital Pazarlama Yöneticisi & InsurTech Danışmanı
            </span>
          </div>
          <div className="hidden md:flex items-center gap-4 text-slate-400 shrink-0 text-xs">
            <a 
              ...
              target="_blank" 
              rel="noreferrer"
              className="hover:text-blue-400 flex items-center gap-1 transition-colors text-slate-300 font-medium"
            >
          ...
          <div className="bg-white border-b border-slate-200 px-4 pt-3 pb-6 space-y-4 shadow-2xl max-h-[calc(100vh-100px)] overflow-y-auto">
            ...
            <div className="pt-3 border-t border-slate-100 flex flex-col gap-2.5">
              ...
              >
                ...
                <span>Ücretsiz 30 Dk Keşif & InsurUp Demosu</span>
              </button>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-full py-3 text-center text-xs font-bold text-slate-900 bg-slate-100 hover:bg-slate-200 border border-slate-300 rounded-xl cursor-pointer flex items-center justify-center gap-2"
              >
            ...
            <div className="pt-3 border-t border-slate-100 flex flex-col gap-2 text-xs text-slate-600">
              <a
                href="mailto:tugceutku.sigorta@gmail.com"
